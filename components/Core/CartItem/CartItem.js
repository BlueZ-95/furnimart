...
export const CartItem = ({ image, title, price }) => {
  return (
    <div className="cart-item items-center mx-2 my-3 cursor-pointer">
      <div className="cart-item__image relative w-40 rounded-3xl max-h-52 overflow-hidden">
        <div className="inline-block absolute top-0 right-0 text-2xl bg-white text-red-500 hover:bg-red-500 hover:text-white rounded-bl-xl p-1">
          <FiX />
        </div>
